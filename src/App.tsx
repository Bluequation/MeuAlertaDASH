...
<div style={cardStyle}>
  ...
  <div style={{display:'flex',flexDirection:'column',gap:'24px'}}>
    ...
    {/* DISTRIBUIÇÃO */}
    <div style={{...cardStyle,minHeight:'205px'}}>
      <h3 style={{color:'#1C1C1E',fontSize:'16px',fontWeight:'700',margin:'0 0 8px'}}>Distribuição</h3>
      ...
      <div style={{height:'155px'}}>
        <ResponsiveContainer width="100%" height="100%">
          <PieChart>
            ...
            >
              {dadosGrafico.map((_,index)=>
                <Cell key={`cell-pie-${index}`} fill={CORES[index%CORES.length]}/>
              )}
            </Pie>
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Transformar a participação da comunidade em informação
            territorial útil, fortalecendo a comunicação, o acompanhamento
            de situações locais e a construção coletiva de um território
            mais informado e conectado.
          </span>
        </div>
